...
export interface TokenInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [boolean, AddressLike, BigNumberish, BigNumberish]
  ): string;
...
export interface Token extends BaseContract {
  ...
  blacklist: TypedContractMethod<
    [_address: AddressLike, _isBlacklisting: boolean],
    [void],
    "nonpayable"
  >;

  blacklists: TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
